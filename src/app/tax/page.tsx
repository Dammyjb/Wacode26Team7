...
export default function TaxPage() {
  ...
  async function generatePDF() {
    ...
    try {
      ...
      y -= 20;
      draw("* This is a demo document generated by Allofood. Consult a tax professional before filing.", 50, 8);
      ...
      a.href = url;
      a.download = `Allofood_Form8283_${new Date().toISOString().split("T")[0]}.pdf`;
      a.click();
